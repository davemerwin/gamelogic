...
class Migration(SchemaMigration):
    ...
    models = {
        'story.story': {
            ...
            'child': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'child_rel_+'", 'to': "orm['story.Story']"}),
            ...
            'parent': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'parent_rel_+'", 'to': "orm['story.Story']"}),
